...
app.post('/modify', (req, res) => {
    const sql = 'UPDATE songs SET sname = ?, composer = ?, lvl1 = ?, lvl2 = ?, lvl3 = ?, lvl4 =' +
...
app.post("/addscore", (req, res) => {
    const sql = 'INSERT INTO scores (player_id, song_id, lvl1_score, lvl2_score, lvl3_score, lv' +
            'l4_score) \
  SELECT p.id, s.id, ?, ?, ?, ? \
  FROM players p \
  JOIN songs ' +
